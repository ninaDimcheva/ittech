                    ...
                    if (this.status === 200) {
                        if (this.responseText != false){
                            ...
                            if(is_admin){
                                ...
                                submit.id = 'submitUserPrivilege';
                                submit.type = 'submit';
                                submit.value = 'Make ' + name + ' ' + family_name + ' an ordinary user';
                                submit.name = 'changeUserPrivilege';
                                submit.className = 'button';
                                editUserPrivilegeForm.appendChild(submit);
                                submit.focus();
                            }else {
                                var note = document.createElement('p');
                                ...
                                submit.id = 'submitUserPrivilege';
                                submit.type = 'submit';
                                submit.value = 'Make ' + name + ' ' + family_name + ' administrator';
                                submit.name = 'changeUserPrivilege';
                                submit.className = 'button';
                                editUserPrivilegeForm.appendChild(submit);
                                submit.focus();
